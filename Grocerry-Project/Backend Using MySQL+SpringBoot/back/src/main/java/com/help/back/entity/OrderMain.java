...
public class OrderMain implements Serializable {
	...
	public OrderMain(@NotNull Long orderId, Set<ProductInOrder> products, @NotEmpty String buyerEmail,
			@NotEmpty String buyerName, @NotEmpty String buyerPhone, @NotEmpty String buyerAddress,
			@NotNull BigDecimal orderAmount, @NotNull Integer orderStatus, LocalDateTime createTime,
